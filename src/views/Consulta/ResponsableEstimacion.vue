<template>
  <main class="px-4 mt-10">
    ...
    <section class="px-4">
      ...
      <tablero-estimacion-residente :options="featureOptions" :headers="headers" :data="app.responsable_estimacion"
        v-if="!app.loading" />
...
export default {
  ...
  setup() {
    ...
    const getQuery = () => {
      ...
      app.value.responsable_estimacion = store.filtros.responsableEstimacion
