<template>
  <main class="px-4 mt-10">
    ...
    <section class="px-4">
      ...
      <tablero-estimacion-residente :options="featureOptions" :headers="headers" :data="app.total"
        v-if="!app.loading" />
...
export default {
  ...
  setup() {
    ...
    const getQuery = () => {
      ...
      console.log('store.filtros.total: ', store.filtros.total);
      console.log('Valor del parámetro:', app.value.total);
